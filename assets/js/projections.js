global.projections = {
    "Mercator / EPSG:3857": {
        ...
        proj4: "+proj=merc +a=6371000 +b=6371000 +lat_ts=0.0 +lon_0=0.0 +x_0=0.0 +y_0=0 +k=1.0 +units=m +no_defs",
        extent: null
    },
    "Sphere Mollweide / ESRI:53009": {
        name: "Sphere Mollweide / ESRI:53009",
        proj4: "+proj=moll +lon_0=0 +x_0=0 +y_0=0 +a=6371000 +b=6371000 +units=m +no_defs",
    ...
    "World Azimuthal Equidistant": {
        ...
        proj4: "+proj=aeqd +lat_0=0 +lon_0=0 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs",
        extent: null
    },
    ...
    "EPSG:5479": {
        name: "EPSG:5479",
        proj4: "+proj=lcc +lat_1=-76.66666666666667 +lat_2=-79.33333333333333 +lat_0=-78 +lon_0=163 +x_0=7000000 +y_0=5000000 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs",
    ...
    "Mollweide internationale Sinusoïdale": {
        ...
        proj4: "+proj=sinu +lon_0=0 +x_0=0 +y_0=0 +a=6371000 +b=6371000 +units=m +no_defs",
        extent: [-18e6, -9e6, 18e6, 9e6]
    ...
    "Equidistant Conic": {
        ...
        proj4: "+proj=eqdc +lon_0=0 +lat_0=0 +x_0=0 +y_0=0 +lat_1=55 +lat_2=60 +units=m +no_defs",
        extent: null

    },
    "Gall Peters": {
        name: "Gall Peters",
        proj4: "+proj=cea +lon_0=0 +lat_ts=45 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs +ellps=WGS84",
    ...
    "Lambert cylindrical equal-area": {
        ...
        proj4: "+proj=cea +lon_0=0 +lat_ts=0 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs +ellps=WGS84",
        extent: [-20037508.34, -10018754.17, 20037508.34, 10018754.17], // Extent in meters
        worldExtent: [-180, -90, 180, 90] // Extent in degrees
    },
    ...
    "Lambert Conformal Conic": {
        ...
        proj4: "+proj=lcc +lat_1=33 +lat_2=45 +lat_0=39 +lon_0=-96 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs",
    ...
    "Natural Earth": {
        name: "Natural Earth",
        proj4: "+proj=eqearth +lon_0=0 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs",
        extent: [-20037508.34, -10018754.17, 20037508.34, 10018754.17], // Extent in meters
        worldExtent: [-180, -90, 180, 90] // Extent in degrees
    },
    "Equirectangular": {
        name: "Equirectangular",
        proj4: "+proj=eqc +lat_ts=0 +lon_0=0 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs",
        extent: [-20037508.34, -10018754.17, 20037508.34, 10018754.17], // Extent in meters
        worldExtent: [-180, -90, 180, 90] // Extent in degrees
    },
    "Polyconic": {
        name: "Polyconic",
        proj4: "+proj=poly +lat_0=0 +lon_0=0 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs +ellps=WGS84",
        extent: [-20037508.34, -10018754.17, 20037508.34, 10018754.17], // Extent in meters
        worldExtent: [-180, -90, 180, 90] // Extent in degrees
    }
};